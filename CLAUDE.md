...
For demo talking points, Pro vs OSS positioning, running demos, and success metrics, see **`docs/DEMO.md`**.
...
This template demonstrates **enterprise MLOps patterns** for **regulated industries**, focusing on multi-environment model promotion with clean developer experience, platform governance, and complete audit trails.

**Key patterns**: Hook-based governance, Model Control Plane, GitOps, dynamic pipelines, 2-workspace architecture

---

**For questions or clarifications, see**:
- `docs/ARCHITECTURE.md` - Complete architecture and organization guide
- `docs/DEMO.md` - Demo talking points and Pro vs OSS positioning
